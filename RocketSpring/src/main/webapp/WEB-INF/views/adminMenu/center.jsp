...
<body>
	<c:choose>
			...
			<div class="sp-slideshow">
				...
				<div class="sp-content">
					...
					<ul class="sp-slider clearfix">
						<li><img src="images/rocket_menu.png"
							alt="image01" /></li>
						<li><img src="images/rocket_menu.png"
							alt="image02" /></li>
						<li><img src="images/rocket_menu.png"
		...
		<c:when test="${menu eq 'corplist' }">
			<div align="left">
				<jsp:include page="./centerleft.jsp"></jsp:include>
			</div>
			<div>
				<iframe width="97%" height="600px" src="./list.joincorp"></iframe>
			</div>
		</c:when>
		<c:when test="${menu eq 'corpinsert' }">
			<div align="left">
				<jsp:include page="./centerleft.jsp"></jsp:include>
			</div>
			<div>
				<iframe width="97%" height="600px" src="./join.joincorp"></iframe>
			</div>
		</c:when>
		<c:when test="${menu eq 'corpinsert' }">
			<div align="left">
		...
		<c:when test="${menu eq 'memberinfo' }">
			<div align="left">
				<jsp:include page="./centerleftmember.jsp"></jsp:include>
			</div>
			<div>
				<iframe width="97%" height="600px" src="./Member.AmmDo?page=1"></iframe>
			</div>
		</c:when>
