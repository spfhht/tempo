...
<body>
   <c:choose>
      ...
      <c:when test="${param.menu eq 'list' }">
         <div align="left">
            <jsp:include page="./centerleft.jsp"></jsp:include>
         </div>
         <div>
            <iframe width="97%" height="600px"
               src="./ListFacility.facility"></iframe>
         </div>
      </c:when>
      
      
      
      <c:when test="${param.menu eq 'insert' }">
         <div align="left">
            <jsp:include page="./centerleft.jsp"></jsp:include>
         </div>
         <div>
            <iframe width="97%" height="600px"
               src="./FacilityInsertView.facility"></iframe>
         </div>
      </c:when>
      ...
      <c:when test="${param.menu eq 'update' }">
         <div align="left">
            <jsp:include page="./centerleft.jsp"></jsp:include>
         </div>
         <div>
            <iframe width="97%" height="600px"
               src="./FacilityUpdateView.facility"></iframe>
         </div>
      </c:when>
      ...
      <c:when test="${param.menu eq 'delete' }">
         <div align="left">
            <jsp:include page="./centerleft.jsp"></jsp:include>
         </div>
         <div>
            <iframe width="97%" height="600px"
               src="./FacilityDeleteView.facility"></iframe>
         </div>
      </c:when>
      
      
      
      <c:when test="${param.menu eq 'managerlist' }">
         <div align="left">
            <jsp:include page="./centerleftmanager.jsp"></jsp:include>
         </div>
         <div>
            <iframe width="97%" height="600px"
               src="./listresult.manager"></iframe>
         </div>
      </c:when>
      
      
      
      <c:when test="${param.menu eq 'managerinsert' }">
         <div align="left">
            <jsp:include page="./centerleftmanager.jsp"></jsp:include>
         </div>
         <div>
            <iframe width="97%" height="600px"
               src="./insertpage.manager"></iframe>
         </div>
      </c:when>
      
      
      
      <c:when test="${param.menu eq 'qna' }">
         <iframe width="97%" height="600px" src="./list.qna"></iframe>
      </c:when>
   </c:choose>
</body>
</html>