			...
			<div id="inner">
				<div id="login-columns">
					...
					<div class="auth-block corner-all" style="height: 400px;">
						<div class="login-top" style="height: 60px;">CorpManager Log In</div>

						<c:choose>
							<c:when test="${(sessionScope.logininfo.group == 3)}">
								<c:redirect
									url="http://localhost/KimsRocketDelivery2/CorpMenu/main.jsp"></c:redirect>
							</c:when>
							<c:otherwise>
								...
								<form id="account-signup" action="./do.login" method="post"
									...
									<fieldset>
										...
										<input type="password" name="pwd" id="pwd" title="epass"
											...
											name="m_group" value="3"> <input type="submit"
