			...
			<div id="inner">
				<div id="login-columns">
					...
					<div class="auth-block corner-all" style="height: 400px;">
						<div class="login-top" style="height: 60px;">Log In</div>
						<form id="account-signup" action="./do.login" method="post"
							...
							<fieldset>
								...
								<input type="password" name="pwd" id="pwd" title="epass"
									class="form-text" style="height: 62px;" placeholder="Password">
								<input type="hidden" name="m_group" value="1"> <input
									type="submit" class="login form-button-default right"
									style="height: 52px" value="LOGIN"
