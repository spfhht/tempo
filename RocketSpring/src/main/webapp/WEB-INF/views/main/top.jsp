	...
	<div class="gnb_area">
		<div class="gnb_contents">
			<div id="topMenu" align="left">
				<ul>
					<li class="topMenuLi"><a href="./usermain"
						title="로켓배송 메인화면으로 가기"><img src="images/logo.jpg"
							alt="로켓배송 사이트 로고" /></a></li>
				</ul>
				<ul>
					<li class="topMenuLi"><a class="menuLink" href="./usermain?menu=reservation">택배예약</a></li>

					<li class="topMenuLi"><a class="menuLink">택배조회</a>
						<ul class="submenu">
							<li><a href="./usermain?menu=deliveryIdCheck"
							...
							<c:choose>
								...
								<c:otherwise>
									<li><a href="./usermain?menu=deliveryCheck" class="submenuLink longLink">개인 택배 조회</a></li>
								</c:otherwise>
							</c:choose>
						</ul></li>
<!-- 
					<li class="topMenuLi"><a class="menuLink"
						...
						<li class="topMenuLi"><a class="menuLink"
						href="./usermain?menu=checkOffice">영업소 조회</a>
					<li class="topMenuLi"><a class="menuLink"
						href="./usermain?menu=qna">QNA</a>
				</ul>
				<div>
